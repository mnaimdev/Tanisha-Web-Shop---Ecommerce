        ...
        <div class="container">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-12 col-lg-4 col-md-12">
                                        ...
                                        <div class="col d-flex align-items-center">
                                            <div class="cart_single_caption pl-2">
                                                ...
                                                <p class="mb-1 lh-1">
                                                    ...
                                                    <input value="{{ $cart->rel_to_size->id }}" name="size_id"
                                                ...
                                                <h4>
                                                    <input type="radio" name="quantity" value="{{ $cart->quantity }}"
                    ...
                    <input type="hidden" name="customer_id" value="{{ $carts->first()->customer_id }}" />
