        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="sp-wrap">
                        @foreach ($product_thumbnails as $thumb)
                            <a href="">
                                <img src="{{ asset('/uploads/product/thumbnail') }}/{{ $thumb->product_thumbnail }}"
                                    alt="">
                            </a>
                        @endforeach
                    </div>
                    ...
                    <div class="prd_details">
                        <form action="{{ route('cart.store') }}" method="POST">
                            ...
                            <div class="prt_01 mb-1"><span
                                    class="text-purple bg-light-purple rounded py-1">{{ $product_info->rel_to_category->category_name }}</span>
                            </div>
                            ...
                            <div class="prt_04 mb-4">
                                ...
                                <div class="text-left pb-0 pt-2" id="size_id">
                                    @if ($available_size == 1)
                                        <h5 class="text-danger">No Size Available</h5>
                                    @else
                                        ...
                                        <div class="text-left">
                                            <div class="text-center">
                                                <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a
                                                        href="shop-single-v1.html">Half
                                                        Running Set</a></h5>
                                                <div class="elis_rty">
                                                    @if ($related->discount)
                                                        <span class="ft-bold fs-md text-dark line-through">৳
                                                            {{ $related->price }}</span>
                                                    @endif
                                                    <span class="ft-bold fs-md text-danger ">৳
                                                        {{ $related->after_discount }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
