                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <small>ORDER</small>
                                                            {{ App\Models\BillingDetails::where('order_id', $order_id)->first()->order_id }}
                                                            <br />
                                                            <small>
                                                                {{ App\Models\BillingDetails::where('order_id', $order_id)->first()->created_at->format('m-d-Y') }}
                                                            </small>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                <td>
                                    <table width="480" border="0" cellpadding="0" cellspacing="0" align="center"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach (App\Models\OrderProducts::where('order_id', $order_id)->get() as $order_product)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <small>
                                                            {{ $order_product->rel_to_product->after_discount }}
                                                        </small>
                                                    </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; white-space:nowrap;"
                                                    width="80">
                                                    {{ App\Models\Orders::where('order_id', $order_id)->first()->sub_total }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    {{ App\Models\Orders::where('order_id', $order_id)->first()->charge }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #b0b0b0; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    <small>
                                                        {{ App\Models\Orders::where('order_id', $order_id)->first()->discount }}
                                                    </small>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    <strong>
                                                        {{ App\Models\Orders::where('order_id', $order_id)->first()->total }}
                                                    </strong>
                                                </td>
                                            </tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    @php
                                                                        $pm = App\Models\Orders::where('order_id', $order_id)->first()->payment_method;
                                                                    ...
                                                                    <br> Credit Card Type:
                                                                    {{ $pm == 1 ? 'N/A' : '' }}<br>
                                                                    Worldpay Transaction ID: <a href="#"
